...
void clrscr(void);
void line(void);
void data_input(int *array_cont, int *array_acum);
void array_input(int *array_cont, int *array_acum, int pos, int valor);
void data_output(int *array_cont, int *array_acum, float prom_pos, float prom_total);
...
int main() {
	...
	/* Input de data */
	data_input(array_cont, array_acum);
	...
	/* Output de data */
	data_output(array_cont, array_acum, prom_pos, prom_total);
	return 0;
}
